 ...
 */
     ...
     */ 
         ...
         * @static 
         */ 
        public static function enumOrFail($type, $enumClass)
        {
                        return \Illuminate\Http\Request::enumOrFail($type, $enumClass);
        }
                    /**
         ...
         * @static 
         */ 
        public static function userOrFail($guard = null)
        {
                        return \Illuminate\Http\Request::userOrFail($guard);
        }
